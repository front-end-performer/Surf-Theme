...
var _menu_mobile = __webpack_require__(329);

var _slide = __webpack_require__(331);

__webpack_require__(333);

var menuMobile = new _menu_mobile.Menu('.menu_trigger-mobile');

var firstSliderElement = document.querySelector('.slider_title');
var mySlideShow2 = new _slide.SlideShowClass(firstSliderElement, 1000);
...
var OPEN_STATE_CLASS_NAME = 'open';

var Menu = function () {
    function Menu(cssSelector) {
...
var SlideShowClass = function () {
    function SlideShowClass(sliderRootElement) {
    ...
    _createClass(SlideShowClass, [{
        ...
        value: function moveSlide(translateAmount) {
            ...
            requestAnimationFrame(function () {
                _this3.slidesList.style.transform = 'translate(' + translateAmount + '%)';
            });
        }
    }, {
        key: 'showSlide',
        ...
        value: function toggleOnPagerItem() {
        ...
        value: function renderPager() {
            ...
            var _loop = function _loop(i) {
                ...
                if (i === _this4.activeSlideIndex) {
                    pagerItem.classList.add('slideshow__pager-item_active');
                }

                pagerItem.addEventListener('click', function () {
                    _this4.activeSlideIndex = i;
                    _this4.toggleOnPagerItem();
                    _this4.showSlide();
                });
                _this4.pagerItems.push(pagerItem);
        ...
        value: function wrap() {
            ...
            this.slides = Array.from(this.sliderRootElement.children).map(function (slideContent) {
                var slide = _this6.renderSlide(slideContent);
                _this6.slidesList.appendChild(slide);
                return slide;
            });
...
exports.SlideShowClass = SlideShowClass;
